...
_EXPECTED_LAYOUT_SNAPSHOT: dict[str, tuple[int, int, int, int, float, float]] = {
    "archive.main": (10, 14, 9, 9, 4.2, 4.2),
    "archive.recovery": (23, 13, 6, 9, 4.2, 4.2),
    "archive.shard": (11, 14, 9, 9, 4.2, 4.2),
    "archive.signing_key_shard": (11, 14, 9, 9, 4.2, 4.2),
    "dossier.main": (10, 14, 9, 9, 4.2, 4.2),
    "dossier.recovery": (21, 11, 6, 9, 4.2, 4.2),
    "dossier.shard": (24, 12, 6, 9, 4.2, 4.2),
    "dossier.signing_key_shard": (24, 12, 6, 9, 4.2, 4.2),
    "forge.main": (24, 14, 6, 9, 4.2, 4.2),
    "forge.recovery": (25, 38, 6, 9, 5.8, 5.8),
    "forge.shard": (9, 10, 9, 9, 4.8, 4.8),
    "forge.signing_key_shard": (8, 11, 9, 9, 4.2, 4.2),
    "ledger.main": (10, 14, 9, 9, 4.2, 4.2),
    "ledger.recovery": (23, 13, 6, 9, 4.2, 4.2),
    "ledger.shard": (11, 14, 9, 9, 4.2, 4.2),
    "ledger.signing_key_shard": (11, 14, 9, 9, 4.2, 4.2),
    "maritime.main": (10, 14, 9, 9, 4.2, 4.2),
    "maritime.recovery": (21, 11, 6, 9, 4.2, 4.2),
    "maritime.shard": (11, 14, 9, 9, 4.2, 4.2),
    "maritime.signing_key_shard": (11, 14, 9, 9, 4.2, 4.2),
    "midnight.main": (10, 14, 9, 9, 4.2, 4.2),
    "midnight.recovery": (21, 11, 6, 9, 4.2, 4.2),
    "midnight.shard": (24, 12, 6, 9, 4.2, 4.2),
    "midnight.signing_key_shard": (24, 12, 6, 9, 4.2, 4.2),
    "monograph.main": (32, 32, 8, 8, 4.2, 4.2),
    "monograph.recovery": (24, 38, 6, 9, 5.8, 5.8),
    "monograph.shard": (10, 10, 9, 9, 4.8, 4.8),
    "monograph.signing_key_shard": (17, 11, 9, 9, 4.2, 4.2),
    "sentinel.main": (24, 14, 6, 9, 4.2, 4.2),
    "sentinel.recovery": (31, 45, 6, 9, 5.8, 5.8),
