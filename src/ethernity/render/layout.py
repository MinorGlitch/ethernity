...
from ..encoding.chunking import payload_to_fallback_lines, reassemble_payload
...
from .geometry import (
    FALLBACK_HORIZONTAL_PADDING_MM,
    FALLBACK_VERTICAL_PADDING_MM,
...
def _calculate_content_positions(
    ...
    *,
    ...
    Returns:
        (margin, header_h, instructions_y, keys_y, content_start_y, usable_w, wrapped_key_lines)
    """
    page_cfg = spec.page
    keys_cfg = spec.keys
    ...
    return margin, header_h, instructions_y, keys_y, content_start_y, usable_w, wrapped_key_lines
...
def _build_fallback_lines(
    ...
    return payload_to_fallback_lines(
        fallback_payload,
