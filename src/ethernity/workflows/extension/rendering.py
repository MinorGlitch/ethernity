...
"""Rendering orchestration for extension execution."""
...
from ethernity.render.validation import validate_rendered_fallback_artifact
from ethernity.workflows.extension.errors import ExtensionWorkflowError
from ethernity.workflows.kit.service import KitAnchor, render_kit_qr_document
...
def render_extension_artifacts(
    ...
    *,
    ...
    render_kit_qr_document(
        output_path=plan.artifacts.recovery_kit_path,
        ...
        render_pdf=render_frames_to_pdf,
    )
