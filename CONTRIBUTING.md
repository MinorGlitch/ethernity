...
This builds both generated recovery kit bundles (lean + scanner variants). They are ignored locally
and regenerated by CI before package and release artifact builds.
